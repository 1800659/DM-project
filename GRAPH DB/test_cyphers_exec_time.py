...
captions =[
    "For each competition give the total number of matches.",
...
def execute_query(query):
    with driver.session() as session:
        ...
        return execution_time, results_list
...
with open("cypher_query_results.html", "w") as html_file:
    ...
    for i, query in enumerate(queries):
        execution_time, result = execute_query(query)
